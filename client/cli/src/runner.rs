...
/// A peer CLI runtime that can be used to run a node or a command
...
impl<C: SubstrateCli> Runner<C> {
	...
	///
	/// ```text
	/// 2020-06-03 16:14:21 peer Node
	/// 2020-06-03 16:14:21 ✌️  version 2.0.0-rc3-f4940588c-x86_64-linux-gnu
	/// 2020-06-03 16:14:21 ❤️  by Peer Technologies <admin@Peer.io>, 2017-2020
