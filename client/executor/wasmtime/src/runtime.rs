...
pub struct Semantics {
	...
	///
	/// The classical runtime environment for peer allowed it and punted this on the runtime
...
enum CodeSupplyMode<'a> {
	...
	Verbatim {
		...
		// some instrumentations for both anticipated paths: peer execution and PVF execution.
		//
