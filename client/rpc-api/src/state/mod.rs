...
pub trait StateApi<Hash> {
	...
	/// interpretation of the traces requires an understanding of the peer chain's block
	/// execution.
	///
	...
	/// - [diener][1] can help to peg commit of peer to what the chain expects.
	...
	/// somewhere in the peer source code. ("Non-hardcoded" targets typically come from frame
	/// support macros.)
	...
	/// [querying peer storage via rpc][3].
	///
