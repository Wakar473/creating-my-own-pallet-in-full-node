...
//!
//! From a node's public key, we can derive its *identity*. In peer and libp2p, a node's
...
//!
//! peer uses the following standard libp2p protocols:
//!
...
//! separate substream.
//!
//! Additionally, peer uses the following non-libp2p-standard protocols:
//!
...
//! alternatives. This is designated as "The legacy peer substream" in this documentation. See
...
//!
//! ## The legacy peer substream
//!
//! peer uses a component named the **peerset manager (PSM)**. Through the discovery
...
//!
//! Within the unique peer substream, messages encoded using
...
//! peer substream. Additionally, the handshake message is hardcoded to be a single 8-bits
