...
//! useful because an honest validator will run peer OCW code, which should be good enough to
...
mod tests {
	...
	fn number_of_voters_allowed_2sec_block() {
		// Just a rough estimate with the peer weights.
