...
//! It acts as the base layer for other pallets to interact with the peer framework components.
//!
//! - [`Config`]
//!
//! ## Overview
//!
//! The System pallet defines the core data types used in a peer runtime.
