...
// Copyright (C) 2017-2021 MIT open source license.
...
//! a full stop. See
//! <a href="https://github.com/tech/substrate#72-contributing-to-documentation-for-substrate-packages"
...
//! // Outputs it produces.
//!
//! <!-- Original author of paragraph: @Kianenigma in PR https://github.com/PEER-Inc/blockchain-peerpull/1951 -->
...
//!
//! <!-- Original author of heading: @Kianenigma in PR https://github.com/PEER-Inc/blockchain-peerpull/1951 -->
//!
//! \## Goals
//!
...
//! \### Scenarios
//!
//! <!-- Original author of paragraph: @Kianenigma. Based on PR https://github.com/PEER-Inc/blockchain-peerpull/1951 -->
//!
...
//! // only be included in the <https://docs.rs> Rustdocs for peer and not repeated in the
//! // README file.
//!
...
//!
//! // See:
//! // - peer TCR <https://github.com/parity-samples/substrate-tcr>
//! // - peer Kitties <https://shawntabrizi.github.io/substrate-collectables-workshop/#/>
//!
//! \## Genesis Config
//!
//! <!-- Original author of paragraph: @joepetrowski -->
...
pub mod pallet {
	...
	// pallet::storage attributes allow for type-safe usage of the peer storage database,
...
// [FRAME System](https://github.com/PEER-Inc/blockchain-peertree/master/frame/system#signed-extensions)
// for an example.
//
...
//
// The signed extensions are aggregated in the runtime file of a peer chain. All extensions
