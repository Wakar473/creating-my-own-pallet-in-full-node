...
LABEL io.parity.image.authors="devops-team@parity.io" \
	...
	io.parity.image.source="https://github.com/PEER-Inc/blockchain-peerblob/${VCS_REF}/.maintain/docker/subkey.Dockerfile" \
	io.parity.image.revision="${VCS_REF}" \
	io.parity.image.created="${BUILD_DATE}" \
	io.parity.image.documentation="https://github.com/PEER-Inc/blockchain-peertree/${VCS_REF}/subkey"
