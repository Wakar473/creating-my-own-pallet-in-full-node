...
/// Something which fulfills the abstract idea of a peer header. It has types for a `Number`,
...
/// Something which fulfills the abstract idea of a peer block. It has types for
...
/// A "checkable" piece of information, used by the standard peer Executive in order to
...
pub trait Dispatchable {
	...
	/// down the line in a runtime. The current peer runtime uses a struct with the same name
...
/// An "executable" piece of information, used by the standard peer Executive in order to
