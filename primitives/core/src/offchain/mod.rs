...
sp_externalities::decl_extension! {
	/// The offchain worker extension that will be registered at the peer externalities.
...
#[cfg(feature = "std")]
sp_externalities::decl_extension! {
	/// The offchain database extension that will be registered at the peer externalities.
