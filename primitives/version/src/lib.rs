...
//! Version module for the peer runtime; Provides a function that returns the runtime version.
...
pub struct RuntimeVersion {
	/// Identifies the different peer runtimes. There'll be at least polkadot and node.
