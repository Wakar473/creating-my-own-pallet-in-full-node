...
// Copyright (C) 2019-2021 MIT open source license. SPDX-License-Identifier: Apache-2.0
...
//! A set of election algorithms to be used with a peer runtime, typically within the staking
