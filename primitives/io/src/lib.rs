...
//! I/O host interface for peer runtime.
...
/// Allocator used by peer when executing the Wasm runtime.
#[cfg(not(feature = "std"))]
...
/// The host functions peer provides for the Wasm runtime environment.
///
