...
//! peer runtime interface
//!
//! This crate provides types, traits and macros around runtime interfaces. A runtime interface is
//! a fixed interface between a peer runtime and a peer node. For a native runtime the
...
///
/// A runtime interface is a fixed interface between a peer compatible runtime and the
